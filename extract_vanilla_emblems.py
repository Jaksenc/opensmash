...
reference sheet (ui_refs/emblem_ref.png).
...
Usage: extract_vanilla_emblems.py [--o2r path] [--out ui_refs/emblem_ref.png]
"""
import argparse
import os
import zipfile
...
def main():
    ...
    ap.add_argument("--out", default=os.path.join(HERE, "ui_refs", "emblem_ref.png"))
