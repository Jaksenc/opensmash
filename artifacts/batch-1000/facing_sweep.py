#!/usr/bin/env python3
"""Run facing_check.py over every built character; one JSON line each -> artifacts/batch-1000/facing-sweep.jsonl"""
...
out = open("artifacts/batch-1000/facing-sweep.jsonl", "a")
def one(s):
