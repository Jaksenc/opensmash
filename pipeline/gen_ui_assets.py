...
Assets produced (matching Mario's sprite layouts exactly):
  ...
  - CSS name:     48x16 IA8 (drawn 47x16) — composed from the game's own
                  letter sprites (website/assets/ui_refs/glyph_*.png, extracted from the
  ...
  - emblem:       48x48 coverage canvas (series-emblem glyph; the engine
                  ...
                  silhouette lands as a blob. See website/assets/ui_refs/emblem_ref.png.
...
def load_atlas(prefix="glyph"):
    atlas = {}
    for p in glob.glob(os.path.join(HERE, "website", "assets", "ui_refs", prefix + "_*.png")):
