...
if __name__ == '__main__':
    ...
    import condensed
    COND = condensed.build(make_glyph, hexrows)
    NARROW = condensed.build_narrow(make_glyph, hexrows)
    data = dict(version=3, source='MNPlayersPortraits name strips', faceColor=[146, 139, 114],
