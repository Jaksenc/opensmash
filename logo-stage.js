...
if (stage && canvas) {
  ...
  // Twenty percent larger than the previous presentation (68% above the
  // original 1/3-scale size).
  const LOGO_SCALE = (1 / 3) * 1.68;
  ...
  new GLTFLoader().load(
    './assets/super-weights-bros-logo.glb',
    gltf => {
    ...
    error => {
      ...
      console.error('Could not load the Super Weights Bros logo GLB', error);
    },
  );
